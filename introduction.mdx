---
title: "Rampart SDK"
description: "Unified TypeScript interface to 52 DeFi protocols on Monad Mainnet"
mode: "wide"
---
...
<div style={{textAlign: 'center', padding: '48px 0 32px'}}>
  ...
  <h1 style={{fontSize: '3rem', fontWeight: 800, margin: '0 0 16px', lineHeight: 1.1}}>
    The DeFi SDK for Monad
  </h1>
  <p style={{fontSize: '1.25rem', color: '#6b7280', maxWidth: '600px', margin: '0 auto 32px'}}>
    One install. 55+ protocols. Lending, DEXes, LSTs, Perps, Yield - and 41 AI tools
    for building autonomous agents on the fastest EVM.
  </p>
